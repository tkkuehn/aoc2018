...
# Just going to trial and error this to get the right elf power
# Lame but I was tired of this puzzle...
contents = []
...
for i in range(y_num):
    ...
    for j in range(x_num):
        ...
        if entity == '#':
            ...
            elves.append(
                    {'id': k, 'type': 'E', 'pos': pos, 'power': 40, 'hp': 200})
            k += 1
...
final_elf_count = len(elves)
print(init_elf_count - final_elf_count)
